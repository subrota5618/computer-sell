...
const AddProuduct = () => {
    ...
    const onSubmit = productData => {
        ...
        fetch(`https://api.imgbb.com/1/upload?key=${image_bb_key}`, {
            ...
            .then(productImageUrl => {
                ...
                fetch(`https://resell-products-subrota22.vercel.app/products`, {
                    method: "POST",
                    headers: {
    ...
    //get category data
    React.useEffect(() => {
        axios.get(`https://resell-products-subrota22.vercel.app/categoriesName`)
    ...
    React.useEffect(() => {
        ...
        axios.get(`https://resell-products-subrota22.vercel.app/categoriesInfo/${categoryName}`)
        ...
        <>
            ...
            <div className="flex flex-row-reverse">
                ...
                <div className='mx-auto shadow-2xl rounded-sm my-9' style={{ width: "55%" }}>
                  ...
                  <h2 className='text-3xl font-bold text-center text-info uppercase
             ...
             <p>Verified Seller</p>
                ...
                text-2xl bg-blue-800  mx-2 rounded-full'></TiTick> </h2>
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" placeholder="Enter your product price"  {...register("ProductPrice", {
                                required: true
                            }
                            )}
                                className="input input-bordered" />
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" placeholder="Enter your product price"  {...register("orginalPrice", {
                                required: true
                            }
                            )}
                                className="input input-bordered" />
