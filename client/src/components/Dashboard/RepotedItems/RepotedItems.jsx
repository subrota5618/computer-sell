...
const RepotedItems = () => {
    ...
    const { data: repotedItems = [], isLoading, refetch } = useQuery({
        ...
        queryFn: () =>
            fetch(`https://resell-products-subrota22.vercel.app/repotedItems`, {
                headers: {
    ...
    const handleReportDelete = (repotedItem) => {
        axios.delete(`https://resell-products-subrota22.vercel.app/deleteRepotedItems/${repotedItem._id}`)
            .then(res => {
    ...
    return (
        <>
            ...
            <h2 className='text-center text-2xl font-bold text-info my-2'> 
            Total 
           <span className='mx-2'>  {
                repotedItems?.length 
            }</span>
            ...
            </div>
            {
                ...
                <p className='text-2xl font-bold text-info text-center 
