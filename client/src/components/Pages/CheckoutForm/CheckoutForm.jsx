...
const CheckoutForm = ({product}) => {
 ...
 const upateDocument = (updateData) => {
    axios.put("https://resell-products-subrota22.vercel.app/updateDatabase" , updateData)
    .then(res  => res.data ) 
    ...
    axios.interceptors.request.use(
        ...
        axios.post("https://resell-products-subrota22.vercel.app/create-payment-intent", price)
            .then((res) => {
