...
const Advertise = () => {
  ...
  const { data: advertiseItems = [], isLoading  , refetch} = useQuery({
    ...
    queryFn: () => fetch(`https://resell-products.vercel.app/advertiseItems`, {
      headers: {
        ...
        <>
          ...
          <div className='my-12'>
            <div className="flex justify-evenly my-10">
              ...
              <div className="hero ml-12 h-80 bg-base-100 my-10">
                <div className="hero-content text-center">
                  <div className="max-w-md backgroundImage">
                    <h1 className="text-5xl font-bold"> Total {advertiseItems?.length} Advertise items available </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-4" id="latest-product">
...

              {
                advertiseItems.map(advertise => advertise.advertise === true &&
                  <div className="card card-compact w-82 h-auto text-lg font-bold bg-base-100 
