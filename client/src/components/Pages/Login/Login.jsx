...
fetch("https://resell-products-subrota22.vercel.app/users" , {
  method:"POST" ,
  headers:{
...
<div className="hero min-h-96 my-8 bg-base-100">
<div className="hero-content flex-col lg:flex-row-reverse">
  <div>
   <img src="https://i.ibb.co/WKtVW7D/login.png"
    alt="login" className='w-full h-screen rounded-md hover:translate-y-4  transition duration-1000'/>
  </div>
