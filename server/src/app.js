...
const runMongoDB = async () => {
   try {
      ...
      //collections 
      const usersCollection = client.db("pc-shop-only").collection("users");
      const categoriesCollection = client.db("pc-shop-only").collection("categories");
      const productsCollection = client.db("pc-shop-only").collection("products");
      const ordersCollection = client.db("pc-shop-only").collection("orders");
      //verify seller 
